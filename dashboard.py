...
if uploaded_file is not None:
    ...
    st.info("👆 위에서 All Order Excel 파일(.xlsx)을 업로드해주세요.")

    st.markdown("""
    ### 📌 대시보드 기능
    1. **주요 KPI** - 총 주문 수, 금액, 취소율
    2. **Order Status 분포** - 상태별 주문 비율
    3. **날짜별 추이** - 일별 주문/취소 트렌드
    4. **SKU별 현황** - 제품별 주문/취소 분석
    5. **출고 여부** - 취소 주문의 Tracking ID 발행 현황
    6. **Payment Method** - 결제 방법별 취소율 분석
    """)
